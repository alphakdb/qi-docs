...
The **uqi** binary is a lightweight user interface for managing stacks. Download it from [alphakdb.com/uqi](https://alphakdb.com/uqi).

With the hub running on your local machine, create a new connection:

- **Type:** q
- **Host:** localhost
- **Port:** 8000 (or your configured hub port)

To connect the UI to a remote server, see [UI Remote Connection](/ui-remote-connection).
